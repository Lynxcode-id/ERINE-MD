 ...
 * 🌟 Note² : Pastikan kamu sudah menginstall module wa-sticker-formatter dan @napi-rs/canvas ~ agar fitur ini berfungsi
 * ─────────────────────────
 * 📝 Type x fitur : plugin esm -- brat takina
 */
...
handler.help = ['brattakina <teks>']
handler.tags = ['maker']
handler.command = /^(brattakina|takinabrat)$/i
handler.limit = true
