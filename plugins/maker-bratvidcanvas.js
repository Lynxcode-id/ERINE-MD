...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    if (!text) {
        return m.reply(`┌˚₊ ๑│ BRAT VIDEO │๑˚₊ ❌\n┇ \n│ ❌ *Masukkan teks yang ingin dijadikan video!*\n│ *Contoh:* ${usedPrefix + command} Halo semuanya mari kita belajar\n┇ \n└˚₊ ๑ ────────────── ๑˚₊\n> © ERINE-AI`)
    }
    ...
    try {
        ...
        let txt = `┌˚₊ ๑│ BRAT VIDEO │๑˚₊ 🎥\n┇ \n│ ✅ *Video berhasil diproses!*\n┇ \n└˚₊ ๑ ────────────── ๑˚₊\n> © ERINE-AI`
        await conn.sendFile(m.chat, outPath, 'brat.mp4', txt, m)
        await m.react('✨')
        ...
        console.error(e)
        await m.react('❌')
        m.reply(`┌˚₊ ๑│ BRAT VIDEO │๑˚₊ ❌\n┇ \n│ ❌ *Gagal memproses video:* ${e.message}\n┇ \n└˚₊ ๑ ────────────── ๑˚₊\n> © ERINE-AI`)
    }
}

handler.help = ['bratvidc <teks>']
handler.tags = ['maker']
handler.command = /^(bratvidc)$/i
handler.limit = true
