 ...
 * 👤 Developer : Lynx
 * ─────────────────────────
 * 📝 Plugin: Maker Brat Gojo (Animated Sticker Edition)
 */
...
const SAFE_ZONE = { a: 270, b: 480, c: 110, d: 405 } // Skala disesuaikan untuk 512x512
const TEXT_STYLE = {
    fontFamily: "PoppinsBratGojoVidSticker",
    maxFontSize: 40,
    minFontSize: 12,
    lineHeight: 1.18,
    color: "#111111",
...
const VIDEO_CONFIG = {
    outputFormat: "mp4",
    fast_progress: true,
    fps: 15, // FPS diturunkan biar size stiker gak bengkak
    width: 512,
    height: 512,
    lyric: {
        maxWordPerLayer: 3,
...
handler.help = ['bratvidgojo <teks>']
handler.tags = ['maker']
handler.command = /^(bratvidgojo|bratgojovid)$/i
handler.limit = true
