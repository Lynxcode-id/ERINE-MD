...
const handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        ...
        const apiUrl = `https://api.synoxcloud.biz.id/canvas/quotes-v2?pp=${encodeURIComponent(pp)}&author=${encodeURIComponent(author)}&text=${encodeURIComponent(textQuote.trim())}`;
