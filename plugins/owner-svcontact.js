 ...
 * ╰─────────────────────────
 * 📝 Plugin      : Auto SV / Get Contact Group (Fix LID Bug)
 */
...
let handler = async (m, { conn, groupMetadata, isOwner }) => {
    ...
    try {
        ...
        for (let i = 0; i < participants.length; i++) {
            ...
            // 🔥 FIX UTAMA: Abaikan ID siluman (LID) dari WA
            if (jid.includes('@lid')) continue;
            // Skip nomor bot lu sendiri
            ...
            // Format vCard murni tanpa item1 aneh-aneh biar ga ngaco
