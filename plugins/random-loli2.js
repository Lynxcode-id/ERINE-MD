...
const handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        const res = await fetch('https://api.synoxcloud.biz.id/random/loli');
        ...
        const caption = `┌˚₊ ๑│ ʀ ᴀ ɴ ᴅ ᴏ ᴍ - ʟ ᴏ ʟ ɪ │๑˚₊ 💙\n┇ \n│ ✨ *Status:* Success\n┇ \n└˚₊ ๑ ────────────── ๑˚₊\n> © ERINE-AI`;
...
handler.help = ['randomloli2'];
handler.tags = ['random'];
handler.command = /^(randomloli2|loli2)$/i;
handler.limit = true;
