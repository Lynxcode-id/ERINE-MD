...
// Fungsi sakti buat nge-upload buffer gambar jadi link URL
...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        // Kirim langsung fotonya murni tanpa adreply aneh-aneh
