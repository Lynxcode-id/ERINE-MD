...
async function webp2mp4(source) {
  try {
    ...
    if (!videoSource) {
      throw new Error('Gagal dapet link video dari Ezgif. Mungkin limit atau file error.');
    }
...
async function webp2png(source) {
  try {
    ...
    if (!imgSource) {
        throw new Error('Gagal dapet link gambar dari Ezgif. Mungkin limit atau file error.');
    }
